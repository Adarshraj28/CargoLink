...
import com.cargolink.app.ui.theme.CardDark
...
import com.cargolink.app.viewmodel.ChatViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ShipmentChatScreen(shipmentId: String, onBack: () -> Unit, viewModel: ChatViewModel = hiltViewModel()) {
